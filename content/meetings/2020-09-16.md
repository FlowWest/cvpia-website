...
* Emphasis on SDM and process 
* Executive Summary
* Clean up of terminology/consistency
* Focused description of single overarching Strategy: 
...
* Annual Adaptive Management Updates
* SIT will review the current prioritizations and assess whether they remain applicable
* Possible that large-scale changes in the understanding could necessitate an update to the prioritization and a revision to this Strategy
* October 2 deadline for submitting addenda to NTRS (send to murkov@flowwest.com and megan_cook@fws.gov)

### Next Steps
508 compliance for official posting to web
Begin five-year cycle
Consider changes to DSMs
Update information needs 

## 10:25-10:40 AM
### 5-year Schedule for NTRS adaptation--Megan Cook (FWS)
* Slow the process down to match work schedules, including implementation of actions in real world. 
* Rod brought up concerns associated with the timing of priorities, noting that they need to be make available by March at the latest to feed into the funding cycle. This will be reviewed again during the October meeting. 
* Brian Ellrott brought up the initiation of an independent science review. 
* Megan will coordinate that in the near future. Brian suggest reassembling the same group of people, if possible, that put together the 2008 Listen to the River report.
...
* Modelers (spring/summer): Integrate model updates, calibrate model, do sensitivity analysis
...
* SIT Oct meeting: Hear results of the review of Model Calibration/Sensitivity Analysis, Discuss results of running current strategies through the model--determine whether existing priorities should remain or be altered, Start developing ideas on new candidate strategies 
...
* SIT March meeting: Review results of candidate strategies, Determine revised set of priorities
* Modelers (spring): revise model based on feedback and do final model run
* SIT calls (summer): Finalize updates to priorities, Present proposed model changes
...
* Submodels Affected
Juvenile Survival
Adult In-river Survival
Reproductive Success
Juvenile Migration Success
...
* Hypotheses: 
More accurate and consistent habitat inputs across all watersheds included in the life cycle models will improve model performance and reduce model uncertainty
Certainty of expected effectiveness of restoration actions (as determined by the life cycle models) will be improved with more accurate and consistent habitat inputs across all watersheds
* Current Inputs 
WUA based (mostly)
Variable age
Variable extent
Different scales of how representative they are, some detailed, some not
Variable hydrologic range
Some high flows, some low flows
Proportional (Suitable Area= f (area* depth suitability * velocity suitability)
Subsampled (representative reaches)
* Proposed Inputs
Driven by 2-D modeling, becoming more available and easier and easier to develop
Instead of proportional suitability, will have range of suitable conditions, captures where habitat is suitable and scaling proportionally for floodplain rearing
...
Watersheds with 2D models 2020-2022
Tuolumne, Mokelumne, American, Yuba, Deer, maybe Stanislaus
Watersheds in charter 2022-2025
American, Yuba, Lower-mid Sac, Upper Sac, Clear, Upper-mid Sac, Feather, Butte, Stanislaus, Lower San Joaquin
Other watersheds 2025 and beyond…
Life cycle model must accommodate old and new habitat inputs
Conduct sensitivity analysis on old vs. new habitat inputs
Output from sensitivity analyses should guide future habitat input updates
...
* Metadata Schema
Ecological Metadata Language schema maps to federally approved metadata standards
EML documents are formatted using XML
Encoding that are human- and machine-readable’
...
* Sacramento Valley
Few remaining historic wetlands
Remnant off-channel habitat in flood bypass system
Sutter Basin = uppermost flood bypass in the Sacramento Valley
Managed wetland for migratory birds and farming
* Ecological role of the Sutter Basin? 
Most abundant spring-run Chinook population
Large juveniles produced
...
Salmon measurement
Water quality
Lower trophic sampling
Wild fish sampling
Stomach contents
* Water conditions driving productivity
* Fish growth correlated to zooplankton densities
Mixed effect model: FL Growth rate = f(water quality & lower food web) + habitat type
* Multiple salmon runs & similar diet
* Next steps: use for the SIT model
How can we incorporate this information into a salmon life cycle model such as the SIT model? 
